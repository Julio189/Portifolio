...
const Inputs:React.FC<InputsProps> = ({ type, placeholder, id }) => {
  return (
    <div className="relative w-full md:w-[49%] my-2">
      <input id={id} type={type} placeholder=' ' required className="relative text-xs md:text-base w-full h-full p-4 text-white bg-transparent rounded-md border-2 border-[#20bbf8] outline-none placeholder:text-white hover:bg-[#112e42] transition peer"/>
      <label 
